...
const handleUpdatePet = async (formData, petId) => {
  ...
  const handleDeletePet =  async (formData, petId) => {
    try {
      const deletedPet = await petService.deletePet(formData, petId)
      console.log(deletedPet)

      if (deletedPetPet.err) {
        throw new Error(deletedPetPet.err);
      }
